                                                    ...
                                                    <form action="{{ route('save_company') }}" method="POST"  enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <textarea  class="form-control" name="mission" placeholder="Mission" required></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <div class="login-horizental cancel-wp pull-left">
                                                                            <button class="btn btn-sm btn-primary login-submit-cs" type="submit">Save Company</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
